...
import {
  addUser, getUser, getUserPreferencesByUserId,
  setPreference, getMyReviews, updateUser,
...
export const userSignUp = async (data: UserSignUpRequest): Promise<UserSignUpResponse> => {
  const joinUserId = await addUser({
    ...
    detailAddress: data.specAddress,
...
export const userUpdate = async (userId: number, data: UserUpdateRequest) => {
