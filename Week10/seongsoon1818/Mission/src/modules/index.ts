...
import { handleUpdateMemberProfile } from "./users/controllers/user.controllers.js";
/*
...
app.use(
    cors({
        origin: ["http://localhost:3000", "http://127.0.0.1:3000", 
            ...
            "http://umcseongsoon.kor.kr", "https://umcseongsoon.kor.kr",
            "http://3.38.39.81:3000"
        ],
        credentials: true,
    })
);
...
app.patch("/users/profile/setup", isLogin, handleUpdateMemberProfile);
